...
Class Projection extends CI_Model
{
    ...
    protected $tab_projection_id = array(
        ...
        "4" => array("table" => "ipw_status_task", "date_filtre" => "startup_time", "tab_colonne" => array("id", "tache_id","plan_id", "plan_name", "nom_tache", "startup_time", "endup_time", "elapsed", "statut", "monitor", "alias", "agent", "jcl_procedure")),
