...
Class Projection extends CI_Model {
    ...
    protected $tab_projection_id = array(
        ...
        "7" => array("table" => "ipw_rept_list_agents", "date_filtre" =>"", "tab_colonne" => array("client_code", "account_id", "product_id", "account_type", "client_name", "device_identifier", "address", "locality", "district", "city", "province")),
