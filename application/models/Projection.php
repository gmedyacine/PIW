...
Class Projection extends CI_Model
{
    ...
    protected $tab_projection_id = array(
        ...
        "2" => array("table" => "ipw_chrg_rep_temps", "date_filtre" => "date_chargement", "tab_colonne" => array("id", "report_nom", "date_chargement")),
        "3" => array("table" => "ipw_crt_masteri", "date_filtre" => "date_oper", "tab_colonne" => array("id", "programme", "date_oper", "temps_execution")),
        "4" => array("table" => "ipw_status_task", "date_filtre" => "startup_time", "tab_colonne" => array("id", "plan_id", "plan_name", "nom_tache", "startup_time", "endup_time", "elapsed", "statut", "monitor", "alias", "agent", "jcl_procedure")),
        "5" => array("table" => "ipw_taches_vega", "date_filtre" => "date_suivi", "tab_colonne" => array("id", "scheduled", "date_suivi", "tache", "num_tsk", "", "plan_id", "plan_name", "jcl_procedure", "libelle", "comments")));
