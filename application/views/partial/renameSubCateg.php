<!-- Modal -->
<div class="modal fade" id="renameSubCategModal" tabindex="-1" role="dialog" aria-labelledby="basicModal" >
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    <form action="<?php echo base_url(); ?>index.php/home/update_sub_biblio" method="post" > 
                        <div class="row form-group hidden">
                            ...
                            <div class="col-md-9">
                                <input type="hidden" id="idSubBiblio" name="idSubBiblio">
                            </div>
                        </div> 
                        ...
                        <div class="form-group">
                            ...
                            <div class="nom col-md-10 col-sm-6 col-xs-12">
                                <input id="nomSubBoblio" name="nomSubBoblio" type="text"  required="required" class="form-control " >
                                <br>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="desc col-md-10 col-sm-6 col-xs-12">
                                <input id="descSubBiblio" name="descSubBiblio" type="text" class="form-control " >
                                <br>
                            </div>
                        </div> 
