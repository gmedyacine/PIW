        ...
        <div class="container-fluid">
          ...
          <div id="am-navbar-collapse" class="collapse navbar-collapse">
            <ul class="nav navbar-nav navbar-right am-user-nav">
                <li class="dropdown"><a href="#" data-toggle="dropdown" role="button" aria-expanded="false" class="dropdown-toggle"><span class="letterpic" title="<?php echo $userName_connected ?>" data-userid="<?php echo $id_user_connected ?>"><?php echo $userName_connected ?>"</span><span class="angle-down s7-angle-down"></span></a>
